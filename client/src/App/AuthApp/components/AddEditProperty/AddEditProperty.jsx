...
const PropertyForm = ({ property = null, onSubmitHandler }) => {
  ...
  return (
    <Dialog open>
      <Paper sx={{display: 'flex', justifyContent: 'center', height: "600px", width:"400px"}}>
      <Stack>
      <TextField sx={{width:"100%", margin: '10px'}} id="outlined-basic" label="name" variant="outlined" />
      <TextField sx={{width:"100%", margin: '10px'}} id="outlined-basic" label="description" variant="outlined" />
      </Stack>
      </Paper>
